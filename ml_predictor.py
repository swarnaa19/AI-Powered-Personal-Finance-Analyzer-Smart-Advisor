...
class ExpenseAnalyzer:
    ...
    def _clean_data(self):
        ...
        self.df["Date"] = pd.to_datetime(self.df["Date"], dayfirst=True, errors="coerce", format="mixed")
    ...
    def _get_complete_pivot(self) -> pd.DataFrame:
        """
        category_month_pivot() jaisa hi, lekin agar sabse latest month
        ka data current real-world date se pehle khatam ho raha hai
        (incomplete/partial month), to use drop kar deta hai taaki
        trend comparisons fair rahein.
        """
